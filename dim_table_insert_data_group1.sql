...
WHEN NOT MATCHED THEN
  INSERT (NAME,ID,SYMBOL,PRICE,BETA,VOLAVG,MKTCAP,LASTDIV,RANGE,CHANGES,COMPANYNAME,EXCHANGE,INDUSTRY,WEBSITE,DESCRIPTION,CEO,SECTOR,DCFDIFF,DCF)
  VALUES (SOURCE.NAME, SOURCE.ID,SOURCE.SYMBOL,SOURCE.PRICE,SOURCE.BETA,SOURCE.VOLAVG,SOURCE.MKTCAP,SOURCE.LASTDIV,SOURCE.RANGE,SOURCE.CHANGES,SOURCE.COMPANYNAME,SOURCE.EXCHANGE,
